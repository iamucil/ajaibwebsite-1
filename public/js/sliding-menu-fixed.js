$(document).ready(function() { 
	...
	$("#skin-select #toggle").click(function() { 
		...
		if($(this).hasClass('active')) {
			...
			$("#skin-select").css({'position':'fixed', "top":"-7px", "height":"100vh" });
			$(".skin-part").css({'top':'0'});
			$(".chat-bottom").css({'margin-left':'260px'});
			 $(".bottom-list-menu").css({'display':'block'});
			...
			$(".profile").css({'top':'-10px'});
			 ...
			 $("#skin-select").css({'position':'fixed', "top":"0", "height":"100vh" });
			 $("#menuwrapper ul li").css({'text-align':'left'});
			 $(".skin-part").css({'top':'10px'});
			 $(".chat-bottom").css({'margin-left':'50px'});
			 $(".bottom-list-menu").css({'display':'none'});
