        ...
        <div class="box-body pad-forty" style="display: block;">
            <form class="form-horizontal" novalidate="true" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        {!! Form::select('vendor_category_id', $categories, old('vendor_category_id', $vendor->vendor_category_id), ['placeholder' => 'Pick a category...', 'class' => 'form-control', 'id' => 'select-category']) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="inputApi" placeholder="Api Parameter"
                                   name="params" value="{{ old('params', $vendor->params) }}">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            {!! Form::select('method', $methods, old('method', $vendor->method), ['placeholder' => 'Pick a method...', 'class' => 'form-control', 'id' => 'select-method']) !!}
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </fieldset>
